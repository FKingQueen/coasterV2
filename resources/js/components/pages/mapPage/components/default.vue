    ...
    <div>
        <div>
            <div class="px-6 space-y-4">
                <div>
                    <p class="text-left font-bold tracking-wide blur-none leading-loose">
                        Overview
                    </p>
                    <p class="w-full tracking-wide blur-none indent-8 leading-loose text-justify">
                        The map page is designed to display crucial data related to
                        coastal erosion and coastal
                        flood
                        hazards. This page serves as an informative resource for stakeholders, researchers, and
                        the
                        general public to understand and visualize the risks associated with coastal areas.
                    </p>
                </div>
                <div>
...
<style>
/* Include any additional styles you need here */
</style>
